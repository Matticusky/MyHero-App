...
- Path can be relative (e.g., `test.aac`) or absolute (e.g., `/Storage/test.aac`)
...
5. DOWNLOAD FILE
   - Write [0x02]["recording1.aac\0"] to Transfer Control
...
7. DELETE FILE
   - Write ["recording1.aac\0"] to File Delete
